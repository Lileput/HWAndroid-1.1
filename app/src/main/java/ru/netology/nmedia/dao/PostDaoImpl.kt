...
class PostDaoImpl(private val db: SQLiteDatabase) : PostDao {
    ...
    override fun save(post: Post): Post {
        val values = ContentValues().apply {
            ...
            put(PostColumns.COLUMN_SHARED_BY_ME, if (post.shareByMe) 1 else 0)
        ...
        return getById(id) ?: throw IllegalStateException("Post not found after save")
    }
    ...
    private fun getById(id: Long): Post? {
        db.query(
            ...
            return if (it.moveToNext()) map(it) else null
        }
    }
